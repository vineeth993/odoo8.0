...
class purchase_order(osv.Model):
    ...
    _columns = {
        'package_and_forwording_type': fields.selection([('include', 'Include'), ('fix', 'Fix Amount'), ('percentage', 'Percentage'), ('per_unit', 'Per Unit'), ('actual', 'At actual')], 'Packaging & Forwarding Type', states={'confirmed':[('readonly', True)], 'approved':[('readonly', True)], 'done':[('readonly', True)]}),
