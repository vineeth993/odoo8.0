...
def migrate(cr, version):
    openupgrade.rename_columns(
        cr, {'purchase_order': [('from_agreement', None)]})
    ...
    openupgrade.logged_query(
        ...
        FROM purchase_recurring_orders_agreement_order AS agreement_order
        WHERE agreement_order.order_id = purchase_order.id
        """)
