...
class StockMoveProperty(models.Model):
    ...
    property = fields.Many2one('product.property', domain="[('id', 'in', possible_properties[0][2])]", string='Property')
    value = fields.Char(required = True, string='Value')
    move = fields.Many2one('stock.move', string='Movement')
...
class ProductProduct(models.Model):
    ...
    properties = fields.Many2many('product.property', string='Properties')