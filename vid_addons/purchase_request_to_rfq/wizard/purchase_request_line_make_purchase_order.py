...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    def _prepare_purchase_order_line(self, po, item):
        ...
        print "222222222222222222", product
        ...
        print "3333333333333"
        vals = po_line_obj.product_id_change(
    ...
    def make_purchase_order(self):
        ...
        purchase = False
        location = False
        print "2222222222", self.item_ids
        ...
        for item in self.item_ids:
            ...
            print "yyyyyyyyyyyyyyyyy", line_picking_type
            ...
            print "yyyyyyyyyyyyyyyyy" , domain
