...
class PurchaseRequisition(osv.Model):
            ...
            for line in requisition.line_ids:
                ...
                if product:
                    seller_price, qty, default_uom_po_id, date_planned = self._seller_details_without_product(
                        cr, uid, line, supplier, requisition, context=context)
                else:
                    seller_price, qty, default_uom_po_id, date_planned = requisition._seller_details_without_product(
    ...
    def _seller_details_without_product(self, cr, uid, requisition_line, supplier, requisition,  context=None):
